 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LGUI | LCTRL |LOWER | /Space  /       \Enter \  |RAISE |RShift|RCTRL |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
...
[_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LPRN,  KC_RPRN,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_LALT, \
                        KC_LGUI, KC_LCTL, MO(_LOWER), KC_SPC,  KC_ENT, MO(_RAISE),KC_RSFT, KC_RCTL \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |                    |   ^  |   &  |   *  |   (  |   )  |   -  |
